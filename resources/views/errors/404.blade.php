...
<div class="min-h-screen w-full relative grid-bg flex items-center justify-center overflow-hidden">
    <div class="absolute inset-0 flex items-center justify-center opacity-10" id="backgroundText">
        <h1 class="text-[25rem] font-jakarta font-medium text-primary shimmer">404</h1>
    </div>
    ...
    <div class="relative z-10 flex flex-col items-center justify-center px-4 max-w-md mx-auto text-center">
        <h2 class="text-4xl md:text-5xl font-jakarta font-semibold mb-6 animate-fade-in">Page not found</h2>
        
        <div class="mb-10">
            <p class="text-gray-700 mb-4 animate-fade-in delay-1">We can't find the page that you're looking for.</p>
            <p class="text-gray-500 animate-fade-in delay-2">Probably the link is broken</p>
        </div>
