...
<div class="account-dashboard py-12 bg-gray-100 md:px-4 md:pb-28">
    <div class="container mx-auto px-4">
        <div class="mb-8">
            ...
            <h1 class="text-3xl md:text-4xl font-bold text-primary">Add New Address</h1>
            <p class="text-gray-600 mt-2 font-jost">Add a new shipping or billing address to your account.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-md mb-8" data-aos="fade-up" data-aos-delay="100">
            <div class="card-header border-b border-gray-200 px-6 py-5 flex items-center">
                ...
                <h3 class="text-lg font-medium text-primary">Address Details</h3>
            </div>
            ...
            <div class="p-6 md:p-8">
                ...
                <form action="{{ route('account.addresses.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="radio" id="shipping" name="address_type" value="shipping" class="h-4 w-4 text-primary border-gray-300 rounded" 
                                        {{ old('address_type', request('address_type')) == 'billing' ? '' : 'checked' }} required>
                                </div>
                            ...
                            <div class="relative flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="radio" id="billing" name="address_type" value="billing" class="h-4 w-4 text-primary border-gray-300 rounded" 
                                        {{ old('address_type', request('address_type')) == 'billing' ? 'checked' : '' }} required>
                                </div>
                                <div class="ml-3 text-sm">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="first_name" id="first_name" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('first_name') }}" required>
                            </div>
                            
                            <div>
                                <label for="last_name" class="block text-sm font-medium text-gray-700 mb-2">Last Name <span class="text-red-500">*</span></label>
                                <input type="text" name="last_name" id="last_name" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('last_name') }}" required>
                            </div>
                            
                            <div>
                                <label for="phone" class="block text-sm font-medium text-gray-700 mb-2">Phone Number <span class="text-red-500">*</span></label>
                                <input type="tel" name="phone" id="phone" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('phone') }}" required>
                            </div>
                            
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email Address <span class="text-red-500">*</span></label>
                                <input type="email" name="email" id="email" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('email') }}" required>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="company" id="company" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('company') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="address_line_1" id="address_line_1" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('address_line_1') }}" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="address_line_2" id="address_line_2" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('address_line_2') }}">
                            </div>
                            
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <label for="city" class="block text-sm font-medium text-gray-700 mb-2">City <span class="text-red-500">*</span></label>
                                    <input type="text" name="city" id="city" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('city') }}" required>
                                </div>
                                
                                <div>
                                    <label for="state" class="block text-sm font-medium text-gray-700 mb-2">State / Province <span class="text-red-500">*</span></label>
                                    <input type="text" name="state" id="state" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('state') }}" required>
                                </div>
                                
                                <div>
                                    <label for="postal_code" class="block text-sm font-medium text-gray-700 mb-2">Postal Code <span class="text-red-500">*</span></label>
                                    <input type="text" name="postal_code" id="postal_code" class="w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" value="{{ old('postal_code') }}" required>
                                </div>
                            </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        <div class="relative flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" id="is_default" name="is_default" value="1" class="h-4 w-4 text-primary border-gray-300 rounded" {{ old('is_default', '1') == '1' ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="is_default" class="font-medium text-gray-700">Set as default address</label>
                                <p class="text-gray-500">Use this address as my default shipping address</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end pt-4">
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" class="inline-flex items-center px-5 py-2.5 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-300">
                                <i class="ri-save-line mr-2"></i> Save Address
                            </button>
                        </div>
                    </div>
                </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Change the default text based on address type selection
    const shippingRadio = document.getElementById('shipping');
    const billingRadio = document.getElementById('billing');
    const defaultAddressText = document.querySelector('label[for="is_default"] + p');
    
    function updateDefaultText() {
        if (billingRadio.checked) {
            defaultAddressText.textContent = 'Use this address as my default billing address';
        } else {
            defaultAddressText.textContent = 'Use this address as my default shipping address';
        }
    }
    
    shippingRadio.addEventListener('change', updateDefaultText);
    billingRadio.addEventListener('change', updateDefaultText);
