...
<body class="bg-dashboard-bg font-jakarta">
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarCollapsed: false }">
        ...
        <div id="sidebar" 
             ...
             :class="sidebarCollapsed ? 'w-16 sidebar-collapsed' : 'w-64'"
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex items-center justify-between h-16 px-4 border-b border-gray-100">
                    ...
                    <!-- Toggle Button inside logo area -->
                    <button 
                        @click="sidebarCollapsed = !sidebarCollapsed" 
                        class="sidebar-toggle focus:outline-none flex items-center justify-center p-1 hover:bg-gray-100 rounded-lg"
                    >
                        <i class="ri-sidebar-unfold-line text-gray-600 text-lg" :class="sidebarCollapsed ? 'transform rotate-180' : ''"></i>
                    </button>
                </div>
                ...
                <nav class="flex-1 pt-4 overflow-y-auto overflow-x-hidden custom-scrollbar">
                    <ul class="space-y-1 px-3">
                        <li>
                            <a href="/" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors active">
                        ...
                        <li>
                            <a href="/" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.orders*') ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="/" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.products*') ? 'active' : '' }}">
                        ...
                        <li x-data="{ open: false }">
                            <div class="tooltip px-4 py-2.5 flex items-center justify-between cursor-pointer text-gray-700 hover:bg-gray-100 rounded-lg nav-item transition-colors" @click="open = !open">
                                <div class="flex items-center">
                                    <i class="ri-folder-line text-lg" :class="sidebarCollapsed ? '' : 'mr-3'"></i>
                                    <span class="nav-text">Collections</span>
                                </div>
                                <i class="ri-arrow-down-s-line transition-transform nav-text" :class="open ? 'transform rotate-180' : ''"></i>
                                <span class="tooltip-text" x-show="sidebarCollapsed">Collections</span>
                            </div>
                            <div x-show="open && !sidebarCollapsed" class="pl-10 pr-4 mt-1 space-y-1" style="display: none;">
                                <a href="#" class="block py-2 px-3 rounded-lg text-gray-600 hover:bg-gray-100 text-sm transition-colors">Categories</a>
                                <a href="#" class="block py-2 px-3 rounded-lg text-gray-600 hover:bg-gray-100 text-sm transition-colors">Product Tags</a>
                            </div>
                        </li>
                        <li x-data="{ open: false }">
                            <div class="tooltip px-4 py-2.5 flex items-center justify-between cursor-pointer text-gray-700 hover:bg-gray-100 rounded-lg nav-item transition-colors" @click="open = !open">
                            ...
                            <div x-show="open && !sidebarCollapsed" class="pl-10 pr-4 mt-1 space-y-1" style="display: none;">
                                <a href="#" class="block py-2 px-3 rounded-lg text-gray-600 hover:bg-gray-100 text-sm transition-colors">Stock</a>
                                <a href="#" class="block py-2 px-3 rounded-lg text-gray-600 hover:bg-gray-100 text-sm transition-colors">Suppliers</a>
                            </div>
                        </li>
                        <li>
                            <a href="" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.customers*') ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.content*') ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.analytics*') ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.marketing*') ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.discounts*') ? 'active' : '' }}">
                        ...
                        <li x-data="{ open: false }">
                            ...
                            <div x-show="open && !sidebarCollapsed" class="pl-10 pr-4 mt-1 space-y-1" style="display: none;">
                                <a href="#" class="block py-2 px-3 rounded-lg text-gray-600 hover:bg-gray-100 text-sm transition-colors">Online Store</a>
                                <a href="#" class="block py-2 px-3 rounded-lg text-gray-600 hover:bg-gray-100 text-sm transition-colors">Marketplaces</a>
                            </div>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="mt-auto border-t border-gray-100 py-3 px-3">
                    <a href="" class="tooltip flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 nav-item transition-colors {{ request()->routeIs('admin.settings*') ? 'active' : '' }}">
        ...
        <div class="flex-1 flex flex-col overflow-hidden content-wrapper transition-all duration-300" 
            ...
            <!-- Footer -->
            <footer class="border-t border-gray-100 py-4 px-6 bg-white">
